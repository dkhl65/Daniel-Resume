...
\begin{document}
    ...
    \section{Summary of Skills}
        \begin{onecolentry}
            \begin{highlights}
                \item 2 years of professional software development experience including building web applications
                \item Learning new technologies quickly and working effectively with distributed teams in multiple countries using clear communication skills
                \item React, Java, TypeScript/JavaScript, and Ruby on Rails
            \end{highlights}
        \end{onecolentry}
