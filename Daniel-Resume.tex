...
\begin{document}
    ...
    \section{Professional Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Improved user interface to the volunteer placement app, using Ruby on Rails, React and PostgreSQL, fixing bugs and adding new features including account confirmation emails using AWS Simple Email Service
                ...
                \item Migrated the website from EC2 to Amplify, eliminating risky SSH dependencies and improving CI/CD and scalability
