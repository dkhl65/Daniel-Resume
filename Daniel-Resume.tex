...
\begin{document}
    ...
    \section{Summary of Skills}
        \begin{onecolentry}
            \begin{highlights}
                \item 2 years of professional software development experience including designing, developing, implementing and supporting enterprise web applications
                \item Ability to learn quickly and strong collaborations skills with cross-functional teams, including software and hardware engineers, and students
                \item JavaScript / TypeScript (React, Redux, Angular.js, Node.js, jQuery), Ruby on Rails, HTML, CSS, SQL, AWS, RESTful APIs, Git
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Professional Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Improved the frontend and backend of the volunteer placement app, using Ruby on Rails, React and PostgreSQL, optimized SQL queries and added user-facing features including account confirmation emails using AWS Simple Email Service
                ...
                \item Suggested and implemented the migration of the website from EC2 to Amplify, eliminating risky SSH dependencies, reducing costs by 50\% and improving CI/CD and scalability
