...
\begin{document}
    ...
    \section{Summary of Skills}
        \begin{onecolentry}
            \begin{highlights}
                \item 2 years of professional software development experience including UI/UX integration and application performance
                \item Tackling technical challenges with strong analytical and problem-solving skills
                \item Conveying technical concepts clearly to diverse audiences with good written and verbal communication skills
                \item Proficiency in frontend technologies (React, JavaScript/Typescript, HTML5, CSS3, Tailwind CSS, Bootstrap
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Professional Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Worked closely with youth outreach staff to improve the frontend and backend of the volunteer placement app, using Ruby on Rails, React and PostgreSQL, including implementing a user-friendly searching interface
                \item Diagnosed and resolved critical performance issues with N+1 queries and repetitive API calls in legacy fullstack code, reducing load time by 70\%
                ...
                \item Migrated the website from EC2 to Amplify, eliminating risky SSH dependencies to align with security best practices, reducing costs by 50\% and improving CI/CD and scalability
            \end{highlights}
        \end{onecolentry}
        \vspace{0.5 cm}
