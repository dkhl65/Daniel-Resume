...
\renewcommand{\familydefault}{\sfdefault} % document font
...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/daniel-liang-957960149}{linkedin.com/in/daniel-liang-957960149}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
    ...
    \section{Professional Experience}
        \begin{twocolentry}{Sept 2023 -- Present}
            \textbf{IT and Bookkeeping Contractor}, Helping Hands --- Mississauga, ON
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Deployed the alpha version volunteer placement app to an EC2 instance using Nginx and Passenger, allowing students and staff to try it out
                \item Maintain and update the organization's website, ensuring accurate information and improved user navigation
        ...
        \begin{twocolentry}{July -- Sept 2023}
            \textbf{Software Developer}, Helping Hands --- Mississauga, ON
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Improved user interface to the volunteer placement app, using Ruby on Rails, React and PostgreSQL, fixing bugs and adding new features including the ability to edit volunteer experiences
                ...
                \item Implemented a CodeDeploy pipeline for website updates, eliminating risky SSH dependencies and procedures
            \end{highlights}
        \end{onecolentry}
        \vspace{0.5 cm}
